    ...
    <View style={styles.root}>
      ...
      >
        ...
        >
          ...
          <Text style={styles.subheading}>Create your admin account</Text>
          ...
          >
            <Text style={styles.fieldIcon}>📅</Text>
            <Text
              style={[styles.fieldText, !dob && styles.fieldPlaceholder]}
            >
...
const styles = StyleSheet.create({
  ...
  subheading: { fontSize: 14, color: "#888", marginTop: 4, marginBottom: 16 },
  label: {
    fontSize: 13,
    color: "#444",
    marginTop: 16,
